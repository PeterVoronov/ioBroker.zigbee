...
*/
    ...
    */
    ...
    curtain_hand_open: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.options !== null) && !isNaN(payload.options) && payload.options.hasOwnProperty(hand_open) && !isNaN(payload.options.hand_open) ? payload.options.hand_open : undefined,
        setterOpt: (value, options) => {
            return {...options, hand_open: value};
        },
    },
    curtain_reset_limits: {
        id: 'reset_limits',
        setattr: 'reset_limits',
        name: 'Reset limits',
        icon: undefined,
        role: 'button',
        write: true,
