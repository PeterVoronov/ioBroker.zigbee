...
*/
    ...
    */
    ...
    curtain_xiaomi_reverse_direction: {
        ...
        setter: (value, options) => {
            return {reverse_direction: value};
        },
        setterOpt: (value, options) => {
            return {state: {'options': {...options, reverse_direction: value}}};
        },
    },
    curtain_xiaomi_hand_open: {
        ...
        setter: (value, options) => {
            return {hand_open: value};
        },
        setterOpt: (value, options) => {
            return {state: {'options': {...options, hand_open: value}}};
        },
    },
    curtain_xiaomi_reset_limits: {
        ...
        inOptions: true,
        setter: (value, options) => {
            return {reset_limits: value};
        },
        setterOpt: (value, options) => {
            return {state: {'options': {...options, reset_limits: value}}};
        },
    },
    blind_position: {
        id: 'position',
